...
Agora criei uma nova pasta dentro do  diretório views  chamado  clintes. 
...
criei um formulário no create.blade.php
...
configurando uma rota para o tratamento da solicitação.
Vá para as  rotas> web.php

Route::resource('clientes', 'ClienteController');

Aqui adicionei a rota de recurso, e todas as funções residem em  app> Http> controllers> ClienteController
...
Aqui temos que devolver a visão quando o pedido atingir a rota; ele será redirecionado para o método de criação desse controlador. 
Nossa visão deve ser acessível através do seguinte URL do formulário.
